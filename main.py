...
@tasks.loop(time=time(hour=2, minute=41, second=0, tzinfo=timezone.utc))
...
@tasks.loop(time=time(hour=2, minute=41, second=30))
...
@tasks.loop(time=time(hour=2, minute=42, second=0))
