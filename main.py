...
@tasks.loop(time=time(hour=2, minute=45, second=0, tzinfo=timezone.utc))
...
@tasks.loop(time=time(hour=2, minute=45, second=30))
...
@tasks.loop(time=time(hour=2, minute=46, second=0))
